...
import com.learn.ecommerce.repository.CartItemRepository;
...
public class CartItemService implements ICartItemService {
    ...
    public void addItemToCart(Long cartId, Long productId, int quantity) {
        // get the cart -> get the product -> check if product already in the cart ->
        // if yeas, increase the quantity -> if no, then add the product to cart
